...
<body>
	<div style="padding: 0 5px;">
		<form id="majorEditFm" class="easyui-form" method="post" 
			...
			<table class="kv-table">
				<tbody>
					<tr>
						...
						<td class="kv-content">
							<input class="easyui-combotree" id="parentTree" name="parentId"
							 style="width: 70%; paddding-right: 2px"></td>
						</td>
						<td class="kv-label">名称</td>
						<td class="kv-content">
						<input type="hidden" value="${major.id}" name="id">
						<input type="hidden" value="${major.parentId }" id="parent_id">
						<input type="hidden" value="${major.returnInfo}" id="returnInfo" name="returnInfo">
						...
						<input class="easyui-textbox" data-options="required:true,validType:['length[0,20]']"
							name="name" value="${major.name}" style="width: 70%; paddding-right: 2px"></td>
					</tr>
					<tr>
						...
						<input class="easyui-numberbox" data-options="required:true,validType:['length[0,3]']"
							name="sortNumber" value="${major.sortNumber}" style="width: 70%; paddding-right: 2px"></td>
					</tr>
					<tr>
						<td class="kv-label">描述</td>
							<td class="kv-content" colspan="3">
						<textarea rows="3" cols="" name="desp" style="width: 90%;paddding-right:2px">${major.desp}</textarea></td>
					</tr>
				</tbody>
			</table>
			</form>
			...
			onclick="editMajor();" style="width: 150px">保存</button>
			</div>
	    </div>
	
	<script type="text/javascript" src="<%=basePath%>common/js/zj/major/majorEditPage.js"></script>
</body>
</html>