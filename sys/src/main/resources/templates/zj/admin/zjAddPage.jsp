...
<body>
	...
	<form id="zjAddFm" class="easyui-form" method="post"
		...
		<table class="kv-table">
			<tbody>
				<tr>
		<input name="id" id="zjAddUid" value="${uuid }" type="hidden">
				...
				<tr class="outerZjHd" style="display: none">
					<td class="kv-label">联系电话</td>
					<td class="kv-content"><input class="easyui-textbox"
						name="phone" style="width: 70%; paddding-right: 2px"
						data-options="required:true,validType:['length[11,11]']">
					</td>
					<td class="kv-label">电子邮箱</td>
					<td class="kv-content"><input class="easyui-textbox"
						name="email" style="width: 70%; paddding-right: 2px"
				...
				<tr class="outerZjHd" style="display: none">
					...
					<td class="kv-content"><input class="easyui-textbox"
						name="belongCompany" style="width: 70%; paddding-right: 2px"
				...
				<tr>
					...
					<td class="kv-content"><input class="easyui-textbox"
						name="speciality" style="width: 70%; paddding-right: 2px"
						data-options="required:true"></td>

					<td class="kv-label">从业年限</td>
					<td class="kv-content"><input class="easyui-numberbox"
						name="years" style="width: 70%; paddding-right: 2px"
						data-options="required:true"></td>
				</tr>
				...
				<tr>
					...
					<td class="kv-content"><input class="easyui-textbox"
						name="achievement" style="width: 70%; paddding-right: 2px"
						data-options="required:true"></td>
	...
	<div style="margin-left: 2px; width: 50%">
		<input type="file" id="file" name="file" onChange="up('${uuid }')">
	...
	<script type="text/javascript"
		src="<%=basePath%>common/js/component/attachment/attachment.js"></script>
	<script type="text/javascript"
		src="<%=basePath%>common/js/component/attachment/ajaxfileupload.js"></script>
	<script type="text/javascript"
		...
		$(function() {
			$("#zjInnerFlag").combogrid({
				onChange : function(newVal, oldVal) {
					if (newVal == "outerzj") {
						$(".outerZjHd input").textbox({
							required : true
						});
						$(".outerZjHd select").combogrid({
							required : true
						});
						$(".outerZjHd").show();
						$.parser.parse(".outerZjHd");
					} else {
						$(".outerZjHd input").textbox({
							required : false
						});
