...
<body>
	<div class="3containrder">
			...
			<table class="kv-table">
				<tbody>
					...
					<td class="kv-label">模板名称</td>
						<td class="kv-content">
						<input value="${templet.id }" name="id" type="hidden">
						<input value="${templet.templetName }" class="easyui-textbox" data-options="required:true"
		...
		<div id="tbMBcc" style="height:auto">
			...
			<a href="javascript:update();"  class="easyui-linkbutton" iconCls="icon-save" >修改并提交</a> 
		</div>
	    </div>
	</div>
