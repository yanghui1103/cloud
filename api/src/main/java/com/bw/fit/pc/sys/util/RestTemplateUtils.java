...
public class RestTemplateUtils {
     ...
     * @return: String
     */
    public  String post(String url, JSONObject params, MediaType mediaType) {
     ...
     * @return: String
     */
    public  <T> T post(String url, JSONObject params, MediaType mediaType, Class<T> clz) {
        RestTemplate restTemplate = new RestTemplate();
    ...
    private  MultiValueMap<String, String> createMultiValueMap(JSONObject params) {
